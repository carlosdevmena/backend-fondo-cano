...
tecnicasRouter.put("/:id", authenticate, authorize(["admin"]), validate(tecnicaPayloadSchema), tecnicasController.patch);
tecnicasRouter.patch("/:id", authenticate, authorize(["admin"]), validate(tecnicaPatchSchema), tecnicasController.patch);
