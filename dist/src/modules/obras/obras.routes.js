...
obrasRouter.put("/:id", authenticate, authorize(["admin"]), validate(obraPayloadSchema), obrasController.patch);
obrasRouter.patch("/:id", authenticate, authorize(["admin"]), validate(obraPatchSchema), obrasController.patch);
